...
- name: BOARD_InitPeripherals
  UUID: e4a02864-296e-48f6-85e0-06e2396f4f19
  called_from_default_init: true
  selectedCore: core0
- name: BOARD_InitButtonsPeripheral
  UUID: 9db584b1-6488-458d-89f2-25907e9b6ca7
  id_prefix: BOARD_
  selectedCore: core0
- name: BOARD_InitLEDsPeripheral
  UUID: 1a985eb1-cf51-48ac-bb32-a289cccdf270
  id_prefix: BOARD_
  selectedCore: core0
- name: BOARD_InitACCELPeripheral
  UUID: 4f390944-9bf8-46e3-ae9e-fa2195198257
  id_prefix: BOARD_
  selectedCore: core0
- name: BOARD_InitMAGPeripheral
  UUID: 8fdcabcc-2505-467f-98a2-c637f9ea4165
  selectedCore: core0
- name: BOARD_InitDEBUG_UARTPeripheral
  UUID: a588f836-d082-402e-bc36-a3d0464d0162
  id_prefix: BOARD_
  selectedCore: core0
